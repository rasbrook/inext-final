            ...
            <div style={{ ...styles.div1 }}>
                ...
                <main style={{ ...styles.whatwedo, display: 'flex', flexWrap: 'wrap' }} >
                    <section>
                        ...
                        <h3 >{isAr ? 'لماذا يهم' : 'Why it matters'}</h3>
                        <p>
                    ...
                    <aside >
                        ...
                        <div >
                            ...
                            <p >{isAr ? 'تقديم استشارات شاملة تنافسية مدعومة بمركز بيانات مركزي وموارد بيئية لتمكين تحول العملاء وتحقيق نتائج مستدامة.' : 'Deliver competitive, one-stop consultation supported by a centralized data hub and eco-resources to enable client transformation.'}</p>
                        </div>
                        ...
                        <div >
                            ...
                            <p >{isAr ? 'حدد موعدًا لاكتشاف الأهداف والتحديات الخاصة بكم.' : 'Schedule a discovery call to review your objectives and challenges.'}</p>
                            <Link to="/About" >
